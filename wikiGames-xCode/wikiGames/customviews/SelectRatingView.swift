...
@objc public protocol SelectRatingViewDelegate {
    /// Returns the rating value when touch events end
    @objc optional func selectRatingView(_ ratingView: SelectRatingView, didUpdate rating: Double)

    /// Returns the rating value as the user pans
    @objc optional func selectRatingView(_ ratingView: SelectRatingView, isUpdating rating: Double)
}

/// A simple rating view that can set whole, half or floating point ratings.
@IBDesignable
@objcMembers
open class SelectRatingView: UIView {
    
    // MARK: Properties
    
    open weak var delegate: SelectRatingViewDelegate?
    ...
    @objc public enum selectRatingViewType: Int {
        /// Integer rating
        case wholeRatings
    ...
    @IBInspectable open var type: selectRatingViewType = .wholeRatings
    ...
    private func updateLocation(_ touch: UITouch) {
        ...
        // Update delegate
        delegate?.selectRatingView?(self, isUpdating: rating)
    }
    ...
    override open func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?) {
        // Update delegate
        delegate?.selectRatingView?(self, didUpdate: rating)
    }
